...
if not os.path.exists("C:/Users/nithi/OneDrive/Desktop/Infosys Springboard/ssofexcel_sc_dt"):
    os.makedirs("C:/Users/nithi/OneDrive/Desktop/Infosys Springboard/ssofexcel_sc_dt")
...
try:
    while True:
        ...
        for face_encoding in face_encodings:
            ...
            if distance < confidence_threshold:
                ...
                if last_recognition_time is None or (now - last_recognition_time) >= entry_duration:
                    ...
                    screenshot_filename = f"ssofexcel_sc_dt/Sai_Nithin_{now.strftime('%Y-%m-%d_%H-%M-%S')}.jpg"
                    ...
                    # Log a new entry for Sai Nithin with screenshot
                ...
                # Draw a rectangle around the face and label it as Sai Nithin
        ...
        if not recognized:
            # If the face is not recognized, label it as 'Not Sai Nithin'
    ...
    if not df.empty:
        df.to_excel('attendance_with_screenshots11.xlsx', index=False)
        print("Attendance and screenshots saved to 'attendance_with_screenshots11.xlsx'.")
