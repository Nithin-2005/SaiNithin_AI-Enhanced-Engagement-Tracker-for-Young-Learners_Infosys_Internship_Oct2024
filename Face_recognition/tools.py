...
while True:
    ...
    for face_encoding in face_encodings:
        ...
        if distance < confidence_threshold:
            ...
            new_entry = pd.DataFrame({'Name': ['Sai Nithin'], 'Date': [date_str], 'Time': [time_str]})
    ...
    if recognition_count >= 5:
        ...
        df.to_excel("C:/Users/nithi/OneDrive/Desktop/Infosys Springboard/Infosys Springboard/Face_recognition/tools.xlsx", index=False)
