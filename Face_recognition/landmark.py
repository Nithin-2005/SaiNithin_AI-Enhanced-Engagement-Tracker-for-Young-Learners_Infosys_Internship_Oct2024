...
p = "C:/Users/nithi/OneDrive/Desktop/Infosys Springboard/Infosys Springboard/shape_predictor_68_face_landmarks/shape_predictor_68_face_landmarks.dat"
detector = dlib.get_frontal_face_detector() #
landmark_predictor = dlib.shape_predictor(p)

# Create a directory to save ssoflandmark
if not os.path.exists("ssoflandmark"):
    os.makedirs("ssoflandmark")
...
try:
    while True:
        ...
        for (top, right, bottom, left), face_encoding in zip(face_locations, face_encodings):
            ...
            if distance < 0.6:
                ...
                screenshot_filename = f"ssoflandmark/{name}_{now.strftime('%Y-%m-%d_%H-%M-%S')}.jpg"
                if attentive:
    ...
    if not df.empty:
        ...
        print("C:/Users/nithi/OneDrive/Desktop/Infosys Springboard/Infosys Springboard/Face_recognition/test.xlsx")
