...
if not os.path.exists("C:/Users/nithi/OneDrive/Desktop/Infosys Springboard/ssofexcel_sc"):
    os.makedirs("C:/Users/nithi/OneDrive/Desktop/Infosys Springboard/ssofexcel_sc")
...
try:
        ...
        for face_encoding in face_encodings:
            ...
            if distance < confidence_threshold:
                ...
                if last_recognition_time is None or (now - last_recognition_time) >= entry_duration:
                    # Save screenshot
                    screenshot_filename = f"ssofexcel_sc/Sai_Nithin_{now.strftime('%Y-%m-%d_%H-%M-%S')}.jpg"
    ...
    if not df.empty:
        df.to_excel('attendance_with_screenshots 21.xlsx', index=False)
